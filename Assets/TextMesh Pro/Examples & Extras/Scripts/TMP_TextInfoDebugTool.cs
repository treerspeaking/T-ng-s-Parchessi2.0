...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // GetComponentWithITargetee a reference to the text object's textInfo
            ...
            // GetComponentWithITargetee the handle size for drawing the various
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // GetComponentWithITargetee Bottom Left and Top Right position of the current character
        ...
        void DrawBounds()
        {
            ...
            // GetComponentWithITargetee Bottom Left and Top Right position of each word
